...
use app\Http\Controllers\api\apiJasaController;
...
Route::get('restapi/jasadetail/{id}', [apiProdukController::class, 'jasadetail'])->name('api.produk.jasadetail');
...
Route::get('restapi/datalaporan/jasa', [apiLaporanController::class, 'jasa'])->name('api.laporan.jasa');
